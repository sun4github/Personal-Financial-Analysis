#2018-02-09 SK: Personal Financial analysis
...
def categorize_transaction(tran_obj):
    ...
    if((tran_obj.amount > 0 and deposits_have_negative_sign == 0 ) or (tran_obj.amount < 0 and deposits_have_negative_sign == 1)):
        ...
        for cat_obj in Transaction_Categories_list:
            ...
            if(re.search(cat_obj['KW'],tran_obj.source,flags=re.IGNORECASE) != None):
                #if(cat_obj['category'] == 'Grocery' or cat_obj['category'] == 'Grocery & Indian'):
                    #print(tran_obj.source + ' matched to ' + cat_obj['category'] + ' for kw: ' + cat_obj['KW'])
    ...
    if(tran_cat != None):
        ...
        if(cat_sum_obj != None):
            ...
            #if(tran_cat == 'Grocery' or tran_cat == 'Grocery & Indian'):
                    #print('summary category is ' + str(cat_sum_obj.category))
            return
        else:
